...
<html lang="en">
  ...
  <tbody>
   ...
   ?> 
    <tr>
      <td><?= $data  ['userId']?></td>
      <td><img src="images/<?= $data['userImage']?>" width="100px" height="70px" style="object-fit: cover;"></td>
      <td><?= $data  ['username']?></td>
      <td><?= $data  ['email']?></td>
      <td><?= $data  ['password']?></td>
      <td><?= $data  ['city']?></td>
     ...
     <a href="update.php?upId=<?= $data ['userId']?> " style="color: black;"><i class="fa-solid fa-pen-to-square"></i></a></td>
    </tr>
   <?php }?>
  </tbody>
</table>
